...
db = sqlite3.connect('attemps_db.db')
cursor = db.cursor()
...
dummy = pygame.image.load('Dummy.webp')
papyrus = pygame.image.load('lox_prosto.jpg')
coming_soon = pygame.image.load('coming_soon.png')
...
class StartMenu(pygame.sprite.Sprite):
    def __init__(self, group, is_start_menu, is_bosses_menu, is_controls_menu, is_credits_menu, is_stats_menu):
        ...
        self.start_image = pygame.image.load('start.jpg')
        self.controls_image = pygame.image.load('controls.jpg')
        self.credits_image = pygame.image.load('credits.jpg')
        self.exit_image = pygame.image.load('exit.jpg')
        self.hardertale_image = pygame.image.load('hardertale.png')
        self.stats_image = pygame.image.load('stats.png')
...
class StatsMenu():
    def __init__(self, is_start_menu, is_stats_menu):
        ...
        self.papyrus_stats = pygame.image.load('papyrus_stats.png')
        self.dummy_stats = pygame.image.load('dummy_stats.png')
        self.atts_now = pygame.image.load('atts_now.png')
        self.best_res = pygame.image.load('best_res.png')
...
class ControlsMenu(pygame.sprite.Sprite):
    def __init__(self, group, is_control_menu, is_start_menu):
        ...
        self.image = pygame.image.load("controls_menu.png")
...
class CreditsMenu(pygame.sprite.Sprite):
    def __init__(self, group, is_credits_menu, is_start_menu):
        ...
        self.image = pygame.image.load("credits_menu.jpg")
...
class BossesMenu(pygame.sprite.Sprite):
    def __init__(self, group, is_fight, is_bosses_menu, is_start_menu):
        ...
        self.start_image = pygame.image.load('start.jpg')
        self.right_arrow_image = pygame.image.load('r_arrow.png')
        self.left_arrow_image = pygame.image.load('l_arrow.png')
...
class Pages():
    ...
    def draw_fight(self, surface, page):
        current_page = self.pages[page]
        width, height = current_page.get_size()
        center_x, center_y = 350, 150
        surface.blit(current_page, (center_x - width // 2, center_y - height // 2))

    def draw_fight_menu(self, surface, page):
        current_page = self.pages[page]
        width, height = current_page.get_size()
        center_x, center_y = 350, 150
        surface.blit(current_page, (center_x - width // 2, center_y - height // 2))
...
class Player(pygame.sprite.Sprite):
    def __init__(self, group, is_fight, is_bosses_menu, is_fight_menu):
        ...
        self.image = pygame.image.load('soul.png')
    ...
    def update(self, up, down, left, right):
        ...
        if pygame.sprite.collide_mask(self, self.up_barrier):
            self.up = False
        if self.up:
            self.rect.y -= 5

        if pygame.sprite.collide_mask(self, self.down_barrier):
            self.down = False
        if self.down:
            self.rect.y += 5

        if pygame.sprite.collide_mask(self, self.left_barrier):
            self.left = False
        if self.left:
            self.rect.x -= 5

        if pygame.sprite.collide_mask(self, self.right_barrier):
            self.right = False
        if self.right:
            self.rect.x += 5
    ...
    def dash_animation(self):
        ...
        self.first_frame_dash = pygame.image.load('first_hide.png')
        self.second_frame_dash = pygame.image.load('second_hide.png')
        self.third_frame_dash = pygame.image.load('third_hide.png')
        self.fourth_frame_dash = pygame.image.load('first_unhide.png')
        self.fifth_frame_dash = pygame.image.load('second_unhide.png')
        self.sixth_frame_dash = pygame.image.load('third_unhide.png')
...
class FightMenu(pygame.sprite.Sprite):
    def __init__(self, group, is_fight, is_fight_menu):
        ...
        self.fight_button = pygame.image.load('fight.png')
        self.act_button = pygame.image.load('act.png')
        self.heal_button = pygame.image.load('heal.png')
        self.mercy_button = pygame.image.load('mercy.png')
...
class DummyAttack(pygame.sprite.Sprite):
    def __init__(self, group):
        self.frame_counter = 0
        self.true_frame_counter = 0
        super().__init__(group)

        self.first_attack_image = pygame.image.load('dummy_second_attack.png')
        self.second_attack_image = pygame.image.load('dummy_first_attack.png')
        self.third_attack_image = pygame.image.load('dummy_third_attack.png')
    ...
    def update(self, pos_player_x, pos_player_y):
        self.frame_counter += 1
...
class VerticalBoneAttack(pygame.sprite.Sprite):
    def __init__(self, group, x):
        self.x = x

        super().__init__(group)

        self.vertical_bone_attack = pygame.image.load('vertical_bone.png')
...
class HorizontalBoneAttack(pygame.sprite.Sprite):
    def __init__(self, group, y):
        self.y = y

        super().__init__(group)

        self.horizontal_bone_attack = pygame.image.load('horizontal_bone.png')
...
class StaticBoneAttack(pygame.sprite.Sprite):
    def __init__(self, group):
        super().__init__(group)

        self.static_bone_attack = pygame.image.load('static_bone.png')
...
class DynamicBoneAttack(pygame.sprite.Sprite):
    def __init__(self, group):
        super().__init__(group)

        self.dynamic_bone_attack = pygame.image.load('dynamic_bone.png')
...
class VerticalBoneAttackSpam(pygame.sprite.Sprite):
    def __init__(self, group, x):
        self.x = x
...
class HorizontalBoneAttackSpam(pygame.sprite.Sprite):
    def __init__(self, group, y):
        self.y = y
...
class FightMenuMessages(pygame.sprite.Group):
    def __init__(self, group):

        super().__init__(group)
        self.rare_screen_first = pygame.image.load('Bolkich.png')
        self.rare_screen_second = pygame.image.load('bolkich2.png')
        self.rare_screen_third = pygame.image.load('upd_page_plz.png')
        self.rare_screen_fourth = pygame.image.load('bbbbbbb.png')
        self.rare_screen_fifth = pygame.image.load('wth.png')

        self.def_screen = pygame.image.load('press_any_button.png')
...
class DummyMusic():
    def __init__(self):
        pygame.mixer.music.load('Undertale OST： 036 - Dummy!.mp3')
        pygame.mixer.music.play(-1)
        pygame.mixer.music.set_volume(0.3)

    def dummy_music_stop(self):
        pygame.mixer.music.stop()


class PapyrusMusic():
    def __init__(self):
        pygame.mixer.music.load('Disbelief Papyrus phase 1 theme - Interstellar Retribution.mp3')
        pygame.mixer.music.play(-1)
        pygame.mixer.music.set_volume(0.3)

    def papyrus_music_stop(self):
        pygame.mixer.music.stop()


fight_menu = FightMenu(fight_menu, is_fight, is_fight_menu)
...
while True:
    for event in pygame.event.get():
        ...
        if not(is_fight) and event.type == pygame.MOUSEBUTTONDOWN:
            mouse_tap_pos = event.pos

        if fight_menu and event.type == pygame.MOUSEBUTTONDOWN:
            mouse_tap_pos = event.pos
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_ESCAPE and is_stats_menu:
                stats_menu.exit()
                mouse_tap_pos = None

            if event.key == pygame.K_ESCAPE and is_controls_menu:
                controls_menu.exit()
                mouse_tap_pos = None

            if event.key == pygame.K_ESCAPE and is_credits_menu:
                credits_menu.exit()
                mouse_tap_pos = None

            if event.key == pygame.K_ESCAPE and is_bosses_menu:
                bosses_menu.exit()
                mouse_tap_pos = None

            if event.key == pygame.K_ESCAPE and is_fight:
                if Pages.pages_counter == 0:
    ...
    if is_fight:
        ...
        if pages == 0:
            ...
            text = font.render(f'hp: {player.dummy_hp}', True, (0, 255, 0))
        ...
        if pages == 1:
            ...
            text = font.render(f'hp: {player.papirus_hp}', True, (0, 255, 0))
            text_rect = text.get_rect(center=(455, 235))
            screen.blit(text, text_rect)
